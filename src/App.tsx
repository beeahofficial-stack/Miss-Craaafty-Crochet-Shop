...
const products: Product[] = [
  { id: 'tulip-bouquet', name: 'Soft Tulip Bunch', category: 'Flowers', price: 1500, image: tulipBouquetImage, note: 'A forever bouquet in soft pinks, tied with a satin ribbon.', tag: 'Bestseller' },
  { id: 'sunflower-stem', name: 'Sunflower Bag Charm', category: 'Flowers', price: 299, image: sunflowerImage, note: 'A tiny sunny bloom made to live on your favourite tote.', tag: 'Tiny joy' },
  { id: 'floral-wall', name: 'Hanging Garden', category: 'Home decor', price: 2000, image: flowerWallImage, note: 'A hand-shaped floral wall piece for a bare little corner.' },
  { id: 'curtain-tie', name: 'Butterfly Curtain Tie', category: 'Home decor', price: 1000, image: curtainImage, note: 'A sweet, functional detail for morning light and soft curtains.' },
  ...
  { id: 'tulip-keychain', name: 'Tulip Pearl Keyring', category: 'Accessories', price: 299, image: tulipKeychainImage, note: 'A satin-bowed pair of tulips with a pearl loop.' },
  { id: 'bow-keychain', name: 'Bow Keyring', category: 'Accessories', price: 299, image: bowKeychainImage, note: 'A soft crochet bow with a tiny bead detail.' },
  ...
  { id: 'winter-mitts', name: 'Ribbon Hand Warmers', category: 'Accessories', price: 699, image: victorianGlovesImage, note: 'Wine crochet, cream edging and a bow you can wear all season.' },
  { id: 'petal-mitts', name: 'Petal Fingerless Mitts', category: 'Accessories', price: 799, image: fingerlessWhiteImage, note: 'Creamy hand warmers with blush pink petal embroidery.' },
  ...
  { id: 'berry-pouch', name: 'Berry Scallop Pouch', category: 'Accessories', price: 799, image: pouchImage, note: 'A slim little pouch with a scalloped cream trim and gold clasp.' },
  { id: 'berry-shawl', name: 'Berry Layered Shawl', category: 'Accessories', price: 1500, image: redCowlImage, note: 'A dramatic burgundy crochet layer for your favourite jeans.' },
